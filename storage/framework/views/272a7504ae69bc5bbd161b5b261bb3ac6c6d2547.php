...
<article
    ...
    <div class="py-6 px-5 lg:flex">
        <div class="flex-1 lg:mr-8">
            <img src="<?php echo e(asset('storage/' . $post->thumbnail)); ?>" class="rounded-xl">
        </div>
...
<?php /**PATH G:\My Drive\Sem7\ITI Project Menna\Laravel-From-Scratch-Blog-Project\resources\views/components/post-featured-card.blade.php ENDPATH**/ ?>